...
var chairmans = [
    ...
    { name: "D. Sivanandhan", title: "Hon'ble Chairman, PCGT", image: "assets/chairman-1.jpg" }
];
...
var faculty = [
    ...
    { name: "Adv. Shivam Jain Kakadia", title: "Convenor, PCGT", image: "assets/faculty-1.jpg" }
];
...
function renderFaculty(containerId) {
    ...
    for (var i = 0; i < faculty.length; i++) {
        ...
        html += '<h3 style="font-weight: bold;">' + f.name + '</h3><p>' + f.title + '</p></div>';
    }
    container.innerHTML = html;
}
...
function renderCommitteeDetail() {
    ...
    var c = null;
    for (var i = 0; i < committees.length; i++) { if (committees[i].id === id) { c = committees[i]; break; } }
    if (!c) c = committees[0];
